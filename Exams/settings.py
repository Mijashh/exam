...
SECRET_KEY = 'django-insecure-*z6h164pm3d6y$q8dz1_^(0(w(ko2s08u4-7n%&6nca1f-nk5b'
...
DATABASES = {
     'default': {
        ...
        'NAME': 'examsdb',          # Replace with your database name
        'USER': 'mizas',              # Replace with your database username
...
# Static URL and root configuration
STATIC_URL = '/static/'
